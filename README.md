...
কোনো অ্যাকাউন্ট নেই, কোনো কুকি নেই, কোনো স্কোরবোর্ড নেই।
...
দর্শকসংখ্যা গোনার জন্য **Vercel Web Analytics** ব্যবহার করা হয় — এটি কুকি ব্যবহার
করে না, ব্যক্তিগত কোনো তথ্য রাখে না, আর প্রতিদিন শনাক্তকারী হ্যাশ রিসেট হয়ে যায়।
বন্ধ করতে চাইলে `app/layout.tsx` থেকে `<Analytics />` লাইনটি মুছে দিন।
