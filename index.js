...
const loadLevelWord = (id) => {
    ...
    fetch(url)
        .then((res) => res.json())
        .then((data) => displayLevelWord(data.data)); // ✅ call displayLevelWord
};
...
<div class="text-2xl font-medium font-bangla">${word.meaning ? word.meaning :'অর্থ পাওয়া যায় নি'}/ ${word.pronunciation? word.pronunciation:'Pronunciationa পাাওয়া যায় নি'}</div>
